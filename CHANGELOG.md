...
### Added
- `resurreccion-daemon`: shell.capture and shell.restore verb handlers for capturing and restoring shell process state (cwd, environment, command line) via ProcShellAdapter, with event-based storage.
